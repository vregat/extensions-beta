...
class MangaReader extends paperback_extensions_common_1.Source {
    ...
    searchRequest(query) {
        var _a;
        return createRequestObject({
            url: "https://www.mangareader.net/search/?nsearch=&msearch=" + encodeURI((_a = query.title) !== null && _a !== void 0 ? _a : ""),
            method: "GET"
        });
    }
    search(data, metadata) {
    ...
    getChapterDetails(data, metadata) {
        ...
        let allPages = eval("let document = {}; " + $("#main script").html() + "; document['mj'];");
        let pages = [];
...
exports.MangaReader = MangaReader;
