...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HanaScans = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const HS_DOMAIN = 'https://hanascan.com';
class HanaScans extends paperback_extensions_common_1.Source {
    constructor(cheerio) {
        super(cheerio);
    }
    ...
    get sourceTags() { return [{ text: "RAW", type: paperback_extensions_common_1.TagType.GREY }]; }
    get rateLimit() {
        return 2;
    }
    get websiteBaseURL() { return HS_DOMAIN; }
    getMangaDetailsRequest(ids) {
        let requests = [];
        for (let id of ids) {
            let metadata = { 'id': id };
